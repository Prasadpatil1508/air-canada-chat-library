...
// ---------- AC AGENT DARK AVATAR: Base64 embedding (dark theme) ----------
val acAgentDarkSource = file("src/commonMain/composeResources/drawable/ac_agent_dark.png")
val generateAcAgentDarkAvatarBase64 = tasks.register("generateAcAgentDarkAvatarBase64") {
    notCompatibleWithConfigurationCache("Task uses project.file() and script references for Base64 embedding")
    inputs.file(acAgentDarkSource)
    val outDir = project.file("build/generated/ac_agent_dark_avatar_base64")
    outputs.dir(outDir)
    onlyIf { acAgentDarkSource.exists() }
    doLast {
        val outputFile = File(outDir, "com/example/chat_poc/ui/AcAgentDarkAvatarData.kt")
        val base64 = Base64.getEncoder().encodeToString(acAgentDarkSource.readBytes())
        outputFile.parentFile.mkdirs()
        outputFile.writeText("""
package com.example.chat_poc.ui

/** Generated by Gradle task generateAcAgentDarkAvatarBase64. Do not edit. */
internal object AcAgentDarkAvatarData {
    const val BASE64: String = "$base64"
}
""".trimIndent())
    }
...
// ---------- AC AGENT LIGHT AVATAR: Base64 embedding (light theme) ----------
val acAgentLightSource = file("src/commonMain/composeResources/drawable/ac_agent_light.png")
val generateAcAgentLightAvatarBase64 = tasks.register("generateAcAgentLightAvatarBase64") {
    notCompatibleWithConfigurationCache("Task uses project.file() and script references for Base64 embedding")
    inputs.file(acAgentLightSource)
    val outDir = project.file("build/generated/ac_agent_light_avatar_base64")
    outputs.dir(outDir)
    onlyIf { acAgentLightSource.exists() }
    doLast {
        val outputFile = File(outDir, "com/example/chat_poc/ui/AcAgentLightAvatarData.kt")
        val base64 = Base64.getEncoder().encodeToString(acAgentLightSource.readBytes())
        outputFile.parentFile.mkdirs()
        outputFile.writeText("""
package com.example.chat_poc.ui

/** Generated by Gradle task generateAcAgentLightAvatarBase64. Do not edit. */
internal object AcAgentLightAvatarData {
    const val BASE64: String = "$base64"
}
""".trimIndent())
    }
...
tasks.matching {
    ...
    if (name.contains("Android")) {
        ...
        dependsOn(generateAcAgentDarkAvatarBase64)
        dependsOn(generateAcAgentLightAvatarBase64)
...
tasks.matching { it.name.endsWith("SourcesJar") || it.name == "sourcesJar" }.configureEach {
    dependsOn(generateConnectConfig)
    dependsOn(generateAiAvatarBase64, generateCustomerAvatarBase64, generateAcAgentDarkAvatarBase64, generateAcAgentLightAvatarBase64, generateHeaderLogoBase64)
}
...
kotlin {
    ...
    sourceSets {
        ...
        getByName("androidMain").kotlin.srcDir("build/generated/ac_agent_dark_avatar_base64")
        getByName("androidMain").kotlin.srcDir("build/generated/ac_agent_light_avatar_base64")
        ...
        iosMain.kotlin.srcDir("build/generated/ac_agent_dark_avatar_base64")
        iosMain.kotlin.srcDir("build/generated/ac_agent_light_avatar_base64")
