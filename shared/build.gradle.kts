...
val githubRepo = System.getenv("GITHUB_REPOSITORY") ?: "Prasadpatil1508/chat-library-poc"
...
publishing {
    repositories {
        ...
        maven {
            name = "GitHubPackages"
            val repo = System.getenv("GITHUB_REPOSITORY") ?: "Prasadpatil1508/chat-library-poc"
